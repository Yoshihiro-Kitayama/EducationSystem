...
@section('content')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <!-- 削除ボタン -->
                                <form action="{{ route('admin.article.destroy', $article->id) }}" method="POST" onsubmit="return confirmDelete('{{ $article->title }}');">
                                    @csrf
                                    @method('DELETE')
    ...
    <!-- JavaScript 読み込み -->
    <script src="{{ asset('js/admin_article_list.js') }}"></script>
@endsection
