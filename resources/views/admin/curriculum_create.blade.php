...
<body>
    <div class="container">
        <div class="row">
            <a href="{{ route('admin.curriculum.list', ['grade_id' => $grade_id ?? null]) }}" class="col-1 btn btn-secondary btn-sm">← 戻る</a>
        ...
        <main class="row">
            <form action="{{ route('admin.curriculum.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="alway-delivery-flg row align-items-center justify-content-center mb-3">
                    <input type="checkbox" class="col-2" name="alway_delivery_flg" id="alway_delivery_flg" {{ old('alway_delivery_flg', $curriculum->alway_delivery_flg) ? 'checked' : '' }}>
