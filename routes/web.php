...
Route::prefix('admin')->namespace('Admin')->name('admin.')->group(function(){
    ...
    Route::group(['middleware' => 'auth:admin'], function (){
        ...
        Route::post('banner_edit', [App\Http\Controllers\Admin\BannerController::class, 'showBannerRegist'])->name('show.banner.submit');
        Route::delete('banner/delete/{id}',[App\Http\Controllers\Admin\BannerController::class, 'showBannerDelete'])->name('show.banner.delete');
    });
});
Auth::routes();
